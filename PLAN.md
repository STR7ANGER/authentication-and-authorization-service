# Authentication and Authorization Service — Build Plan
...
Clean/hexagonal service architecture: Next.js admin and hosted auth UI; Hono TypeScript edge/API gateway; Go identity core; PostgreSQL/Prisma; Redis sessions and rate limits.
...
Next.js, TypeScript, shadcn/ui, Zustand, Hono, Go, Prisma, PostgreSQL, Redis, Docker

## Core domain

User, Identity, Credential, Session, RefreshToken, Organization, Membership, Role, Permission, MfaFactor, ApiKey, SecurityEvent.

## API strategy

OAuth/OIDC-compatible endpoints and REST commands; GraphQL admin queries; signed webhooks for security events.
